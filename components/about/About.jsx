  ...
  return (
    <section className="flex min-h-fit " id='about'>
      <div className="container   px-2 py-24">
        {/* title */}
        <h2 className="mb-32 text-center text-4xl font-bold "><span className="text-gradient">|</span> About me</h2>
        {/* content */}
        <div className="grid grid-cols-1 md:grid-cols-2 ">
          <div className="flex flex-col gap-4 relative">
            ...
            <p>
              ...
              because each language will offer different strengths for building
              apps. Studying at NAIT has helped me a lot to decide which stream
              I will spend time cultivating more. The reason why I chose the
